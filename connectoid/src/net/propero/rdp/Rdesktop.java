...
public class Rdesktop {
	...
	public static void main(String[] args) throws OrderException,
		...
		if (fFullscreen) {
			 ...
			 * Toolkit.getDefaultToolkit().getScreenSize(); // ensure width a
			 * multiple of 4 Options.width = screen_size.width & ~3;
			 * Options.height = screen_size.height; Options.fullscreen = true;
			 * if (fFullscreenKdeHack) { Options.height -= 46; }
			 */
		} else {
			Options.width = 800;
			Options.height = 600;
		...
		if (os.startsWith("Linux"))
			...
			// TODO(pv): Detect Android and remove above
		}
