...
public class Bitmap {
	 ...
	 */
    public static WrappedImage decompressImgDirect(int width, int height, int size, RdpPacket_Localised data, int Bpp, int left, int top, WrappedImage w) throws RdesktopException {
